...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 18, 2023 at 06:44 AM
...
CREATE TABLE `activities` (
  ...
  `behavior` enum('Turbulent','Conformist','Solitary','Friendly') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Friendly',
  `team_work` enum('Excellent','Very Good','Good','Acceptable') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Good',
  `performance_evaluation` enum('Excellent','Very Good','Good','Acceptable') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Good',
...
(5, 40, 'Turbulent', 'Acceptable', 'Acceptable', '2023-03-15 13:29:42', '2023-03-15 13:29:42', 1),
...
(11, 85, 'Turbulent', 'Very Good', 'Very Good', '2023-03-30 09:02:41', '2023-03-30 09:02:41', 13),
...
(1, 'Cumque.', 'Rem et.', '2023-03-15 13:54:52', '2023-03-15 13:54:52', 1, 1, 2),
(2, 'Doloribus.', 'Adipisci.', '2023-03-15 13:54:52', '2023-03-15 13:54:52', 1, 1, 2),
(3, 'Ut quia.', 'Nostrum.', '2023-03-15 13:54:52', '2023-03-15 13:54:52', 1, 1, 1),
...
(10, 'new dis', 'new type', '2023-03-15 16:37:36', '2023-03-15 16:37:36', 1, 1, 1),
...
CREATE TABLE `attendences` (
  ...
  `attendence_status` enum('Presence','Absence') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Presence',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `child_id` int(10) UNSIGNED NOT NULL,
  `emp_id` int(10) UNSIGNED NOT NULL
...
(10, '2017-03-10', 'Absence', '2023-03-15 13:42:04', '2023-03-15 13:42:04', 1, 9),
...
CREATE TABLE `children` (
  ...
  `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `age` int(11) NOT NULL,
  `grade` enum('1','2','3','4','5','6') COLLATE utf8_unicode_ci NOT NULL DEFAULT '1',
  `gender` enum('male','female') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'male',
  `health_condition` enum('normal','special') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'normal',
  `image` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `height` int(11) NOT NULL,
  `weight` int(11) NOT NULL,
  `blood` enum('A+','A-','B+','B-','AB+','AB-','O+','O-') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'A+',
  `class` enum('A','B','C') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'A',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `admin_id` int(10) UNSIGNED NOT NULL DEFAULT 1,
  `father_id` int(10) UNSIGNED NOT NULL,
  `activitydataset_id` int(10) UNSIGNED NOT NULL,
  `qr_code` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `child_code` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'Ofelia', 12, '1', 'female', 'normal', NULL, 84, 61, 'A-', 'B', '2023-03-15 13:27:13', '2023-03-15 13:27:13', 1, 1, 3, NULL, NULL),
...
(11, 'koilu', 10, '5', 'male', 'normal', 'child Images/SZnEirshW9muJ62ijrPv5JUzq11DM17gfLcxFwhY.png', 100, 50, 'A+', 'A', '2023-03-15 15:00:11', '2023-03-15 15:00:11', 1, 1, 1, NULL, NULL),
(12, 'oilupl', 10, '5', 'male', 'normal', 'child Images/SulQdE2Lxl0Bog7F80IEHPpahaZbA843B0TdWWh4.png', 100, 50, 'A+', 'A', '2023-03-15 15:08:10', '2023-03-15 15:08:10', 1, 1, 1, NULL, NULL),
(13, 'oilupl', 10, '5', 'male', 'normal', NULL, 100, 50, 'A+', 'A', '2023-03-25 18:18:14', '2023-03-25 18:18:14', 1, 1, 4, NULL, NULL),
(14, 'oilupl', 10, '5', 'male', 'normal', 'childImages/4tc5RpjERXQg9X6Gcw6I5UAqEOMdssSqUgYCUmJN.png', 100, 50, 'A+', 'A', '2023-03-25 18:19:29', '2023-03-25 18:19:29', 1, 1, 4, NULL, NULL),
(15, 'oiliop', 10, '5', 'male', 'normal', 'childImages/nxxaBNFBUXLQRKGh5BMfyqYBQa5tRoeWyOtCYRsF.png', 100, 50, 'A-', 'A', '2023-03-26 07:31:04', '2023-03-26 07:31:04', 1, 1, 3, NULL, NULL),
(16, 'mnjhui', 10, '5', 'male', 'normal', NULL, 100, 50, 'A+', 'A', '2023-04-17 13:12:48', '2023-04-17 13:12:48', 1, 1, 4, 'MziIerqX6OymzAqNpMXs9dQsb.png', NULL),
(17, 'mnjuiokh', 10, '5', 'female', 'normal', NULL, 100, 50, 'A+', 'A', '2023-04-17 13:15:48', '2023-04-17 13:15:48', 1, 1, 4, '8GRpr5WBvIzntv4kYSPogzRLk.png', NULL),
(18, 'kolpi', 8, '2', 'female', 'normal', 'childImages/V9WhLZ0nuMnx2CnT8N7Tvmajfo9SVR8nZBQOOoWN.png', 100, 50, 'A-', 'A', '2023-04-19 19:59:09', '2023-04-19 19:59:09', 1, 1, 3, 'aHZVGyGfwnmXmcPMkJUCuS7TA.png', NULL),
(19, 'jnuio', 8, '2', 'female', 'normal', 'childImages/nb5cZkS7VGX6wrzNx8Z9XCJPHk1DBJ9B6RgpQTeJ.png', 100, 50, 'A-', 'A', '2023-04-19 20:01:08', '2023-04-19 20:01:08', 1, 1, 3, 'g2nvhu7rycm82yzAsxM3YrG5i.png', 'LXYgzA'),
(20, 'jnuio', 8, '2', 'female', 'normal', 'childImages/UDgMtI4PfdwLvHH7jISZbKs9CicH0CVvHkfbqBuO.png', 100, 50, 'A-', 'A', '2023-04-24 19:12:29', '2023-04-24 19:12:29', 1, 1, 3, 'ZNB1j6JYMjPjfcuoMgyNRla7G.png', '5Nvdpm'),
(21, 'oilupl', 10, '5', 'male', 'normal', NULL, 100, 50, 'A+', 'A', '2023-05-08 07:06:04', '2023-05-08 07:06:04', 1, 1, 4, 'gkcAk51JaIyof7mBcSEIN1vX5.png', '4rG5jg'),
(22, 'oilupl', 10, '5', 'male', 'normal', NULL, 100, 50, 'A+', 'A', '2023-05-08 07:24:45', '2023-05-08 07:24:45', 1, 1, 4, NULL, 'pXqP4y');
...
CREATE TABLE `employees` (
  ...
  `email` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `password` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `job_title` enum('Doctor','Teacher','Manager','Seller','Specialist') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Teacher',
  `image` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `fathers` (
  ...
  `gender` enum('male','female') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'male',
  `image` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `status` enum('accepted','rejected') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'rejected',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `access_token` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `username` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'parent',
  `admin_id` int(10) UNSIGNED NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'luk', 'olana@grenta.com', '$2y$10$Lqcg5e2EcFCKCm.Nd4rgeO47d6cJmw1fPer7Q2sM.Q4PYolyQEzvG', 'lhfvhlkd sfdoif5 ppi', '+457851455265', 'female', 'FatherImages/1XKGLLuYsHTE7MFBUDBrQucGFr8ACN7CsQAKqZz6.png', 'rejected', '2023-03-15 13:26:15', '2023-05-14 06:22:25', 'ywlOOuMVUgGhX7ucKQk8FmCD1j3y2lk2UgGkdGGfK65mZKw6vgfccUtISaMtR8qo', 'parentElise', 1),
...
CREATE TABLE `healthdatasettypes` (
  `id` int(10) UNSIGNED NOT NULL,
  `dis_type` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `admin_id` int(10) UNSIGNED NOT NULL DEFAULT 1,
  `healthdatasetname_id` int(10) UNSIGNED NOT NULL
...
CREATE TABLE `healths` (
  `id` int(10) UNSIGNED NOT NULL,
  `banded_food` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `medicien` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `medical_analysis` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `personal_comment` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `father_id` int(10) UNSIGNED NOT NULL,
  `child_id` int(10) UNSIGNED NOT NULL
...
(1, 'Juice', 'moljub nhju', NULL, NULL, '2023-03-15 13:33:05', '2023-03-21 12:31:44', 1, 1),
(2, 'Chocolate', 'Ola nuvia', NULL, 'Fugit nisi ab et et maxime. Culpa error itaque inventore enim.', '2023-03-15 13:33:05', '2023-03-15 13:33:05', 1, 1),
...
(1, 'Perferendis laboriosam ut doloremque velit fugit pariatur saepe. Earum qui vel laudantium possimus. Rerum vitae omnis mollitia velit.', '2023-03-15 13:36:14', '2023-03-15 13:36:14', 1, 1, 7),
(2, 'Error fuga reprehenderit quia qui perferendis ut. Omnis ut quia omnis.', '2023-03-15 13:36:15', '2023-03-15 13:36:15', 1, 1, 7),
(3, 'Sed sunt iure dolor cupiditate. Esse dolore nulla et animi odio tempore. In nihil illo quasi. Aliquam nobis consequatur occaecati optio.', '2023-03-15 13:36:15', '2023-03-15 13:36:15', 1, 1, 7),
...
CREATE TABLE `issues` (
  ...
  `from` enum('Child','Employee','Family','Others') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Others',
  `reason` enum('Psychologically','Healthily','Difficulty in Compatibility','economically','Others') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Others',
  `take_action` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `emp_id` int(10) UNSIGNED NOT NULL,
  `child_id` int(10) UNSIGNED NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
...
(3, '', 'Hic veritatis odit magnam cupiditate autem animi placeat. Inventore et ut qui eius unde illum et. Voluptas iste quo est sequi nesciunt possimus.', 'Employee', 'Others', 'Omnis reprehenderit illum doloribus atque laudantium voluptatem. Aut beatae qui dolores ut. Iure quaerat sapiente placeat aut.', 8, 1, '2023-03-15 13:43:06', '2023-03-15 13:43:06'),
(4, '', 'Qui quisquam sit dignissimos earum qui. Omnis minus perferendis enim placeat eveniet. A tempora totam molestiae provident aut quos iusto. Delectus nesciunt repellendus aliquam.', 'Employee', 'Others', 'Facere est et modi excepturi inventore repellat. Labore iure alias placeat sit sequi. Eius enim voluptas aperiam molestiae quia soluta et. Veritatis laborum in molestiae impedit ut aperiam rerum.', 8, 1, '2023-03-15 13:43:06', '2023-03-15 13:43:06'),
...
(14, 'ko', 'pop finish boj', 'Child', 'Psychologically', 'lop klpk hyu', 8, 1, '2023-05-25 17:24:09', '2023-05-25 17:24:09');
...
CREATE TABLE `posts` (
  ...
  `father_reply` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `emp_id` int(10) UNSIGNED NOT NULL,
  `child_id` int(10) UNSIGNED NOT NULL,
...
(13, 'mokl', 'killed', 'bnhuy ytrge d ddxnijn', 'plo', NULL, '2023-05-25 18:03:15', '2023-05-25 18:03:15', 8, 1, 1);
...
CREATE TABLE `subjects` (
  ...
  `mark` int(11) NOT NULL DEFAULT 0,
  `behavior` enum('Turbulent','Conformist','Solitary','Friendly') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Friendly',
  `activity` enum('Excellent','Very Good','Good','Acceptable') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Good',
  `interact` enum('Excellent','Very Good','Good','Acceptable') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Good',
  `team_work` enum('Excellent','Very Good','Good','Acceptable') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Good',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `father_id` int(10) UNSIGNED NOT NULL,
...
(9, 54, 'Friendly', 'Acceptable', 'Acceptable', 'Acceptable', '2023-03-15 13:30:30', '2023-03-15 13:30:30', 1, 1, NULL),
(10, 45, 'Turbulent', 'Very Good', 'Excellent', 'Very Good', '2023-03-15 13:30:30', '2023-03-15 13:30:30', 2, 5, NULL),
(11, 70, 'Turbulent', 'Very Good', 'Very Good', 'Very Good', '2023-03-28 22:46:34', '2023-03-28 22:46:34', 1, 4, NULL),
...
(1, 'Debitis eum ut ex nobis. Nemo delectus est quae minima. Velit sit ducimus atque consequatur. Omnis et nesciunt dolore optio excepturi tempore consequatur.', '2023-03-15 13:37:52', '2023-04-15 13:37:52', 1, 1, 2, 4, NULL),
(2, 'Ipsam aut eligendi enim deserunt sit numquam. Eaque cumque magni nihil ducimus rerum. Ducimus et maxime nobis.', '2023-03-15 13:37:52', '2023-05-15 13:37:52', 1, 1, 6, NULL, 3),
(3, 'Ut non in eum aut. Minus inventore a cupiditate ut numquam. Rerum temporibus aut ut consequatur.', '2023-03-15 13:37:52', '2023-06-15 13:37:52', 1, 1, 2, 4, NULL),
...
(5, 'In hic enim totam doloremque. Ut quod iste qui. Mollitia quo nihil accusamus eaque.', '2023-03-15 13:38:08', '2023-03-15 13:38:08', 1, 1, 6, NULL, 3),
(6, 'Quis doloremque atque vero sint qui molestias. Assumenda et accusamus nihil quaerat aspernatur ut. Temporibus praesentium iste labore eos.', '2023-03-15 13:38:08', '2023-03-15 13:38:08', 1, 1, 6, NULL, 3),
...
INSERT INTO `watches` (`id`, `heart_rate`, `created_at`, `updated_at`, `child_id`) VALUES
(1, 20, '2023-05-04 06:43:15', '2023-05-14 06:16:09', 20),
(8, 70, '2023-05-04 07:20:48', '2023-05-04 07:21:28', 19);
